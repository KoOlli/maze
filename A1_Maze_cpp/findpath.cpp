...
bool s21::FindPath::CanStep(Direction direction, const std::vector<int>& position) const {
    if (direction == Direction::kRight && maze_.getRightWalls()[position[1]][position[0] - 1] == 0)
        return true;
    if (direction == Direction::kLeft && maze_.getRightWalls()[position[1]][position[0]] == 0)
        return true;
    if (direction == Direction::kUp && maze_.getBottomWalls()[position[1]][position[0]] == 0)
        return true;
    if (direction == Direction::kDown && maze_.getBottomWalls()[position[1] - 1][position[0]] == 0)
        return true;
    return false;
}
...
s21::FindPath::Direction s21::FindPath::ChangeClockwise(s21::FindPath::Direction direction) {
    switch (direction) {
        case s21::FindPath::Direction::kUp: return s21::FindPath::Direction::kRight;
        case s21::FindPath::Direction::kRight: return s21::FindPath::Direction::kDown;
        case s21::FindPath::Direction::kDown: return s21::FindPath::Direction::kLeft;
        case s21::FindPath::Direction::kLeft: return s21::FindPath::Direction::kUp;
...
s21::FindPath::Direction s21::FindPath::ChangeCounterClockwise(s21::FindPath::Direction direction) {
    switch (direction) {
        case s21::FindPath::Direction::kUp: return s21::FindPath::Direction::kLeft;
        case s21::FindPath::Direction::kLeft: return s21::FindPath::Direction::kDown;
        case s21::FindPath::Direction::kDown: return s21::FindPath::Direction::kRight;
        case s21::FindPath::Direction::kRight: return s21::FindPath::Direction::kUp;
        default: throw std::out_of_range("Not expected direction value");
    }
}
