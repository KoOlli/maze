  ...
  for (int i = 0; i < n; ++i) {
    for (int j = 0; j < m; ++j) {
      ...
      connect(button, &QPushButton::clicked, this,
              [this, i, j]() { MainWindow::buttonClicked(i, j); });
...
void MainWindow::on_SaveBtn_clicked() { ui->openGLWidget->SaveFile(); }
...
void MainWindow::on_CreatePathBtn_clicked() { ButtonsView(true); }
